...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ItemContainer = __webpack_require__(167);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      for (var i = 0; i < data.length; i++) {
	        var prodName = 'Product ' + Math.random().toString(32).substr(2, 5);
	        data[i].text = prodName;
	        data[i].price = parseInt(Math.random().toString(10).substring(2, 4));
	        _store2.default.dispatch((0, _actions.addProduct)(data[i]));
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ItemContainer = __webpack_require__(194);
	...
	var _fontAwesome = __webpack_require__(209);

	var _fontAwesome2 = _interopRequireDefault(_fontAwesome);

	var _masonry = __webpack_require__(217);
	...
	var ItemContainer = function (_React$Component) {
	  ...
	  function ItemContainer(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ItemContainer).call(this, props));

	    _this.displayName = 'ItemContainer';
	    _this.state = { total: 0, _filterBy: '' };
	    return _this;
	  }
	  ...
	  _createClass(ItemContainer, [{
	    ...
	    key: 'changeFilter',
	    value: function changeFilter(e, filter) {
	      this.props.dispatch((0, _actions.filterProductsBy)(filter));
	    }
	  }, {
	    key: 'filterProducts',
	    value: function filterProducts() {
	      ...
	      switch (this.props.activeFilter) {
	        ...
	        default:
	          var products = this.props.products.filter(function (e, index) {
	            return e.type.toLowerCase().match(_this2.props.activeFilter);
	          });
	          return products;
	      }
	    }
	    ...
	    value: function render() {
	      ...
	      products = products.map(function (e, index) {
	        return _react2.default.createElement(
	          Item,
	          { key: index, id: e.id, price: e.price, addTotal: function addTotal(e) {
	              return _this3.addTotal(e);
	            }, images: e.images },
	          e.text
	        );
	      });
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(Filter, { onSelect: function onSelect(e, v) {
	            return _this3.changeFilter(e, v);
	          }, activeFilter: this.props.activeFilter }),
	        _react2.default.createElement(
	          'div',
	          { className: 'rowX products' },
	          ' ',
	          products
	        ),
	  ...
	  _createClass(Filter, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            { href: '#', onClick: function onClick(e) {
	                return _this5.props.onSelect(e, 'all');
	              } },
	            'All'
	          )
	        ),
	        _react2.default.createElement(
	          'li',
	          { className: this.props.activeFilter == 'shoe' ? 'active' : '' },
	          _react2.default.createElement(
	            'a',
	            { href: '#', onClick: function onClick(e) {
	                return _this5.props.onSelect(e, 'shoe');
	              } },
	            'Shoes'
	          )
	        ),
	        _react2.default.createElement(
	          'li',
	          { className: this.props.activeFilter == 'shirt' ? 'active' : '' },
	          _react2.default.createElement(
	            'a',
	            { href: '#', onClick: function onClick(e) {
	                return _this5.props.onSelect(e, 'shirt');
	              } },
	            'Shirts'
	          )
	        )
	...
	var Item = function (_React$Component3) {
	  ...
	  function Item(props) {
	    ...
	    _this6.displayName = 'Item';
	    _this6.state = { liked: false, activeColorID: 0 };
	    return _this6;
	  }
	  ...
	  _createClass(Item, [{
	    ...
	    value: function handleClick(e) {
	      ...
	      _store2.default.dispatch((0, _actions.addCart)({ id: this.props.id, price: this.props.price, text: this.props.children }));
	      //this.props.addTotal( liked? this.props.price : -this.props.price );
	    }
	  }, {
	    key: 'selectColor',
	    value: function selectColor(e, index) {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'img' },
	            _react2.default.createElement('img', { src: '/products/product' + this.props.id + '/' + this.props.images[this.state.activeColorID] })
	          ),
	          _react2.default.createElement(
	            'ul',
	            ...
	            this.props.images.map(function (image, index) {
	              return _react2.default.createElement(
	                'li',
	                { key: index, className: _this7.state.activeColorID == index ? 'active' : '', onClick: function onClick(e) {
	                    return _this7.selectColor(e, index);
	                  } },
	                _react2.default.createElement('img', { src: '/dist/products/product' + _this7.props.id + '/' + image })
	              );
	            })
	          ),
	          _react2.default.createElement(
	            'a',
	            { className: 'action-a', onClick: function onClick(e) {
	                return _this7.handleClick(e);
	              } },
	            _react2.default.createElement('i', { className: 'fa fa-cart-plus', 'aria-hidden': 'true' })
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	        ...
	        _react2.default.createElement('i', { className: "fa fa-heart like " + (this.state.liked ? 'active' : ''), onClick: function onClick(e) {
	            return _this7.handleLike(e);
	          } })
	      );
	    }
	  }]);
	...
	var ConnectedParent = (0, _reactRedux.connect)(mapStateToProps)(ItemContainer);

	exports.default = ConnectedParent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _redux.createStore)(__webpack_require__(200));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (0, _redux.combineReducers)({
		cart: __webpack_require__(201),
		products: __webpack_require__(203),
		activeFilter: __webpack_require__(204)
	});
	    ...
	    case types.REMOVE_CART:
	      {
	        ...
	        return [].concat(_toConsumableArray(state.slice(0, removeIndex)), _toConsumableArray(state.slice(removeIndex + 1)));
	      }
...
/***/ function(module, exports) {
	...
	var FILTER_BY = exports.FILTER_BY = 'FILTER_BY';
	    ...
	    case types.ADD_PRODUCT:
	      {
	        ...
	        return [].concat(_toConsumableArray(state), [action.product]); //return state.concat([action.product]);
	      }
	    default:
	      return state;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.filterProductsBy = filterProductsBy;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cart = function (_React$Component) {
	    ...
	    function Cart(props) {
	        ...
	        _this.displayName = 'Cart';
	        return _this;
	    }

	    _createClass(Cart, [{
	        key: 'deleteItemFromCart',
	        value: function deleteItemFromCart(e, id) {
	            this.props.dispatch((0, _actions.removeCart)(id));
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            var totalPrices = items.length ? items.map(function (item) {
	                return parseInt(item.price);
	            }).reduce(function (a, b) {
	                return a + b;
	            }) : 0;

	            items = items.map(function (e, index) {
	                return _react2.default.createElement(Item, { onClick: function onClick(e, id) {
	                        return _this2.deleteItemFromCart(e, id);
	                    }, key: index, text: e.text, price: e.price, id: e.id });
	            });
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement('i', { className: 'fa fa-cart-arrow-down', style: { fontSize: '2em' }, 'aria-hidden': 'true' }),
	                    _react2.default.createElement(
	                        'span',
	                        null,
	                        items.length
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            null,
	                            'Cart ',
	                            items.length ? items.length + ' items' : 'is empty'
	                        )
	                    ),
	                    _react2.default.createElement(
	                        'div',
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'a',
	                        { href: '#', onClick: function onClick(e, id) {
	                                return _this4.props.onClick(e, _this4.props.id);
	                            } },
	...
	var ConnectedCart = (0, _reactRedux.connect)(mapStateToProps)(Cart);

	exports.default = ConnectedCart;
...
/***/ function(module, exports) {
	...
	module.exports = [{ id: 1, text: 'Product A', type: 'shirt', price: 110, images: ['p1.png', 'p2.png', 'p3.png'] }, { id: 2, text: 'Product B', type: 'shirt', price: 220, images: ['p1.png', 'p2.png', 'p3.png'] }, { id: 3, text: 'Product C', type: 'shirt', price: 70, images: ['p1.png', 'p2.png', 'p3.png'] }, { id: 4, text: 'Product D', type: 'shoe', price: 90, images: ['p1.png', 'p2.png', 'p3.png'] }, { id: 5, text: 'Product E', type: 'shoe', price: 45, images: ['p1.png', 'p2.png', 'p3.png'] }, { id: 6, text: 'Product F', type: 'shoe', price: 67, images: ['p1.png', 'p2.png', 'p3.png'] }, { id: 7, text: 'Product G', type: 'shoe', price: 30, images: ['p1.png', 'p2.png', 'p3.png'] }];
